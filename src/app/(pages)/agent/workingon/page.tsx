...
import { getCustomerTypeApi } from "@/api/api";
                        ...
                        >
                          ...
                          <td className="align-middle text-sm text-center font-normal px-6  py-3">
                            <button
                              ...
                              className="h-[30px] bg-[#D71A21] w-[max-content] text-white font-[400] rounded-[10px] flex justify-center items-center px-[14px]"
                            >
                              Upload a Quote
                            </button>
                          </td>
                            ...
                            <div className="flex flex-col gap-1">
                              ...
                              <button
                               title="Irrelevant"
                                ...
                                onClick={() =>
                                  changeRank("irrelevant", item?.productId._id)
                                }
                              ></button>
                              <button
                               title="done"
