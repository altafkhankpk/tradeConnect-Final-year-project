      ...
      <div className="w-full relative sm:px-10 px-5 py-10">
        <div className="">
          ...
          <div className="">
            ...
            <div className=" pt-4">
                <h1 className=" text-[#D91921] uppercase font-[700]">1 Questions</h1>
            ...
            <div
            >
                <div className=" sm:min-w-[500px] sm:max-w-[630px]">
                <p className="text-[30px] text-center sm:text-[25px] font-[600]  mt-[15px]">
             What is the maximum number of orders you can handle in a day?
            ...
            >
              <input
                ...
                className="h-[65px] w-full sm:min-w-[500px] sm:max-w-[530px] mx-auto rounded-[17px] outline outline-[2px] outline-gray-200 focus:outline-[--red] px-[30px] font-[500]"
                placeholder=""
              />
               <div className=" w-full">
               <hr className=" m-0" />
               </div>
              <div className="flex sm:min-w-[500px] sm:max-w-[530px] mx-auto mt-[10px]">
                
                <Link
                  href={"/agent/auth/register/questions/agentquestion_12"}
