      ...
      <div className="w-full relative sm:px-10 px-5 py-10">
        <div className="">
          ...
          <div className="">
            ...
            <div className=" pt-4">
                <h1 className=" text-[#D91921] uppercase font-[700]">7 Questions</h1>
            ...
            >
              ...
              What are your company&#39;s warehouses located?
            ...
            >
              ...
              <div className="flex sm:min-w-[500px] mx-auto sm:max-w-[530px] mt-[10px]">
                ...
                <Link
                  href={"/agent/auth/register/questions/agentquestion_6"}
