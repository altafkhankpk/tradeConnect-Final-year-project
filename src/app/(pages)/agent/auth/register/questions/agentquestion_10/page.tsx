      ...
      <div className="w-full relative sm:px-10 px-5 py-10">
        <div className="">
          ...
          <div className="">
            ...
            <div className=" pt-4">
                <h1 className=" text-[#D91921] uppercase font-[700]">2 Questions</h1>
            ...
            >
                ...
                With how many orders can you cope with on a daliy basic with your current workforce?
            ...
            >
              <input
                ...
                className="h-[65px] w-full sm:min-w-[500px] mx-auto sm:max-w-[530px] rounded-[17px] outline outline-[2px] outline-gray-200 focus:outline-[--red] px-[30px] font-[500]"
                placeholder=""
              />
               <div className=" w-full">
               <hr className=" m-0" />
               </div>
              <div className="flex sm:min-w-[500px] mx-auto sm:max-w-[530px] mt-[10px]">
                
                <Link
                  href={"/agent/auth/register/questions/agentquestion_11"}
