      ...
      <div className="w-full relative sm:px-10 px-5 py-10">
        <div className="">
          ...
          <div className="">
            ...
            <div className=" pt-4">
                <h1 className=" text-[#D91921] uppercase font-[700]">4 Questions</h1>
            ...
            >
              ...
              How many orders are you handing currently per day?
            ...
            >
              ...
              <div className="flex sm:min-w-[500px] sm:max-w-[530px] mx-auto mt-[10px]">
                ...
                <Link
                  href={"/agent/auth/register/questions/agentquestion_9"}
