...
import { HeadingAgentSchema } from "@/schema/agentSchema";
...
const Login = () => {
  ...
  const Formik = useFormik({
    initialValues,
    validationSchema: HeadingAgentSchema,
  ...
  const goBack = () => {
    router.push(`/agent/auth/register/account/createaccount_3`);
  };
          ...
          <div className=" flex mt-[40px] justify-between items-center">
            ...
            <div>
              <form
                ...
                className="mt-[12px] flex flex-col gap-[30px] w-full sm:w-auto items-center"
              >
                ...
                <p className="text-[15px] sm:text-[16px] text-gray-500 mt-[-25px] text-center">
                  For example: &quot;The best agent in China with fast
                  shipping&quot;
                </p>
                <input
                  type={"text"}
                ...
                <div className="flex w-full sm:min-w-[500px] sm:max-w-[530px] mt-[10px]">
                  <button
                    disabled={loader}
                    type="submit"
