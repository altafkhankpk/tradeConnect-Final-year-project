...
import { googleApi, signinApi } from "@/api/api";
...
const Login = () => {
  ...
  const Formik = useFormik({
    ...
    onSubmit: async (value, { resetForm }) => {
      console.log(value);
      setLoader(true);
      const response = (await signinApi(value)) as loginData;
        ...
        <div className="bg-[--red] flex-1 px-[10px] py-[35px] sm:p-[35px] rounded-[30px]">
          ...
          >
            ...
            <p>
              ...
              <span className="text-[--red] font-[700]">$62,000 in a year</span>{" "}
          ...
          <div className="mt-[20px] flex flex-col gap-[15px] text-[15px] sm:text-[16px]">
            <div className="flex gap-[10px] text-white font-[500]">
              ...
              <p>
                <span className="font-[700]">Earn more efforlessly</span> - 99%
                of customers find better prices for their products in our app,
            ...
            <div className="flex gap-[10px] text-white font-[500]">
              ...
              <p>
                ...
                your dedicated agent handle every order, shipping, and tracking
                so focus on what really matters: skyrocketing your marketing and
                sales!
              </p>
            </div>
            <div className="flex gap-[10px] text-white font-[500]">
            ...
            <div className="flex gap-[10px] text-white font-[500]">
              <IoIosArrowDown className="min-w-[22px] h-[23px]" />
              <p>
                <span className="font-[700]">Say goodbye to scams!</span> - Our
                100% verified agents and secure payment systems like Stripe
                ensure your dropshipping journey is safe and sound.
              </p>
            </div>
          </div>
        </div>
